...
func (_StakingPoolProxy *StakingPoolProxyCaller) GetDecimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _StakingPoolProxy.contract.Call(opts, &out, "getDecimals")
...
//
// Solidity: function getDecimals() view returns(uint8)
func (_StakingPoolProxy *StakingPoolProxySession) GetDecimals() (uint8, error) {
	return _StakingPoolProxy.Contract.GetDecimals(&_StakingPoolProxy.CallOpts)
}

// GetDecimals is a free data retrieval call binding the contract method 0xf0141d84.
//
// Solidity: function getDecimals() view returns(uint8)
func (_StakingPoolProxy *StakingPoolProxyCallerSession) GetDecimals() (uint8, error) {
	return _StakingPoolProxy.Contract.GetDecimals(&_StakingPoolProxy.CallOpts)
}
...
func (_StakingPoolProxy *StakingPoolProxyCaller) GetLatestPrice(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _StakingPoolProxy.contract.Call(opts, &out, "getLatestPrice")
...
//
// Solidity: function getLatestPrice() view returns(uint256)
func (_StakingPoolProxy *StakingPoolProxySession) GetLatestPrice() (*big.Int, error) {
	return _StakingPoolProxy.Contract.GetLatestPrice(&_StakingPoolProxy.CallOpts)
}

// GetLatestPrice is a free data retrieval call binding the contract method 0x8e15f473.
//
// Solidity: function getLatestPrice() view returns(uint256)
func (_StakingPoolProxy *StakingPoolProxyCallerSession) GetLatestPrice() (*big.Int, error) {
	return _StakingPoolProxy.Contract.GetLatestPrice(&_StakingPoolProxy.CallOpts)
}
...
func (_StakingPoolProxy *StakingPoolProxyTransactor) PriceConsumerInitialize(opts *bind.TransactOpts, _oracle common.Address) (*types.Transaction, error) {
	return _StakingPoolProxy.contract.Transact(opts, "__PriceConsumer_initialize", _oracle)
}

// PriceConsumerInitialize is a paid mutator transaction binding the contract method 0x37c4f6a4.
//
// Solidity: function __PriceConsumer_initialize(address _oracle) returns()
func (_StakingPoolProxy *StakingPoolProxySession) PriceConsumerInitialize(_oracle common.Address) (*types.Transaction, error) {
	return _StakingPoolProxy.Contract.PriceConsumerInitialize(&_StakingPoolProxy.TransactOpts, _oracle)
}

// PriceConsumerInitialize is a paid mutator transaction binding the contract method 0x37c4f6a4.
//
// Solidity: function __PriceConsumer_initialize(address _oracle) returns()
func (_StakingPoolProxy *StakingPoolProxyTransactorSession) PriceConsumerInitialize(_oracle common.Address) (*types.Transaction, error) {
	return _StakingPoolProxy.Contract.PriceConsumerInitialize(&_StakingPoolProxy.TransactOpts, _oracle)
}
