...
func (_StakingPoolStorageStructure *StakingPoolStorageStructureCaller) GetDecimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _StakingPoolStorageStructure.contract.Call(opts, &out, "getDecimals")
...
//
// Solidity: function getDecimals() view returns(uint8)
func (_StakingPoolStorageStructure *StakingPoolStorageStructureSession) GetDecimals() (uint8, error) {
	return _StakingPoolStorageStructure.Contract.GetDecimals(&_StakingPoolStorageStructure.CallOpts)
}

// GetDecimals is a free data retrieval call binding the contract method 0xf0141d84.
//
// Solidity: function getDecimals() view returns(uint8)
func (_StakingPoolStorageStructure *StakingPoolStorageStructureCallerSession) GetDecimals() (uint8, error) {
	return _StakingPoolStorageStructure.Contract.GetDecimals(&_StakingPoolStorageStructure.CallOpts)
}
...
func (_StakingPoolStorageStructure *StakingPoolStorageStructureCaller) GetLatestPrice(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _StakingPoolStorageStructure.contract.Call(opts, &out, "getLatestPrice")
...
//
// Solidity: function getLatestPrice() view returns(uint256)
func (_StakingPoolStorageStructure *StakingPoolStorageStructureSession) GetLatestPrice() (*big.Int, error) {
	return _StakingPoolStorageStructure.Contract.GetLatestPrice(&_StakingPoolStorageStructure.CallOpts)
}

// GetLatestPrice is a free data retrieval call binding the contract method 0x8e15f473.
//
// Solidity: function getLatestPrice() view returns(uint256)
func (_StakingPoolStorageStructure *StakingPoolStorageStructureCallerSession) GetLatestPrice() (*big.Int, error) {
	return _StakingPoolStorageStructure.Contract.GetLatestPrice(&_StakingPoolStorageStructure.CallOpts)
}
...
func (_StakingPoolStorageStructure *StakingPoolStorageStructureTransactor) PriceConsumerInitialize(opts *bind.TransactOpts, _oracle common.Address) (*types.Transaction, error) {
	return _StakingPoolStorageStructure.contract.Transact(opts, "__PriceConsumer_initialize", _oracle)
}

// PriceConsumerInitialize is a paid mutator transaction binding the contract method 0x37c4f6a4.
//
// Solidity: function __PriceConsumer_initialize(address _oracle) returns()
func (_StakingPoolStorageStructure *StakingPoolStorageStructureSession) PriceConsumerInitialize(_oracle common.Address) (*types.Transaction, error) {
	return _StakingPoolStorageStructure.Contract.PriceConsumerInitialize(&_StakingPoolStorageStructure.TransactOpts, _oracle)
}

// PriceConsumerInitialize is a paid mutator transaction binding the contract method 0x37c4f6a4.
//
// Solidity: function __PriceConsumer_initialize(address _oracle) returns()
func (_StakingPoolStorageStructure *StakingPoolStorageStructureTransactorSession) PriceConsumerInitialize(_oracle common.Address) (*types.Transaction, error) {
	return _StakingPoolStorageStructure.Contract.PriceConsumerInitialize(&_StakingPoolStorageStructure.TransactOpts, _oracle)
}
