...
func (_StakingPoolImplementationForTest *StakingPoolImplementationForTestCaller) GetDecimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _StakingPoolImplementationForTest.contract.Call(opts, &out, "getDecimals")
...
//
// Solidity: function getDecimals() view returns(uint8)
func (_StakingPoolImplementationForTest *StakingPoolImplementationForTestSession) GetDecimals() (uint8, error) {
	return _StakingPoolImplementationForTest.Contract.GetDecimals(&_StakingPoolImplementationForTest.CallOpts)
}

// GetDecimals is a free data retrieval call binding the contract method 0xf0141d84.
//
// Solidity: function getDecimals() view returns(uint8)
func (_StakingPoolImplementationForTest *StakingPoolImplementationForTestCallerSession) GetDecimals() (uint8, error) {
	return _StakingPoolImplementationForTest.Contract.GetDecimals(&_StakingPoolImplementationForTest.CallOpts)
}
...
func (_StakingPoolImplementationForTest *StakingPoolImplementationForTestCaller) GetLatestPrice(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _StakingPoolImplementationForTest.contract.Call(opts, &out, "getLatestPrice")
...
//
// Solidity: function getLatestPrice() view returns(uint256)
func (_StakingPoolImplementationForTest *StakingPoolImplementationForTestSession) GetLatestPrice() (*big.Int, error) {
	return _StakingPoolImplementationForTest.Contract.GetLatestPrice(&_StakingPoolImplementationForTest.CallOpts)
}

// GetLatestPrice is a free data retrieval call binding the contract method 0x8e15f473.
//
// Solidity: function getLatestPrice() view returns(uint256)
func (_StakingPoolImplementationForTest *StakingPoolImplementationForTestCallerSession) GetLatestPrice() (*big.Int, error) {
	return _StakingPoolImplementationForTest.Contract.GetLatestPrice(&_StakingPoolImplementationForTest.CallOpts)
}
...
func (_StakingPoolImplementationForTest *StakingPoolImplementationForTestTransactor) PriceConsumerInitialize(opts *bind.TransactOpts, _oracle common.Address) (*types.Transaction, error) {
	return _StakingPoolImplementationForTest.contract.Transact(opts, "__PriceConsumer_initialize", _oracle)
}

// PriceConsumerInitialize is a paid mutator transaction binding the contract method 0x37c4f6a4.
//
// Solidity: function __PriceConsumer_initialize(address _oracle) returns()
func (_StakingPoolImplementationForTest *StakingPoolImplementationForTestSession) PriceConsumerInitialize(_oracle common.Address) (*types.Transaction, error) {
	return _StakingPoolImplementationForTest.Contract.PriceConsumerInitialize(&_StakingPoolImplementationForTest.TransactOpts, _oracle)
}

// PriceConsumerInitialize is a paid mutator transaction binding the contract method 0x37c4f6a4.
//
// Solidity: function __PriceConsumer_initialize(address _oracle) returns()
func (_StakingPoolImplementationForTest *StakingPoolImplementationForTestTransactorSession) PriceConsumerInitialize(_oracle common.Address) (*types.Transaction, error) {
	return _StakingPoolImplementationForTest.Contract.PriceConsumerInitialize(&_StakingPoolImplementationForTest.TransactOpts, _oracle)
}
...
// UpdateMaturingPrice is a paid mutator transaction binding the contract method 0xa7a48681.
//
// Solidity: function updateMaturingPrice(uint256 _price) returns()
func (_StakingPoolImplementationForTest *StakingPoolImplementationForTestTransactor) UpdateMaturingPrice(opts *bind.TransactOpts, _price *big.Int) (*types.Transaction, error) {
	return _StakingPoolImplementationForTest.contract.Transact(opts, "updateMaturingPrice", _price)
}

// UpdateMaturingPrice is a paid mutator transaction binding the contract method 0xa7a48681.
//
// Solidity: function updateMaturingPrice(uint256 _price) returns()
func (_StakingPoolImplementationForTest *StakingPoolImplementationForTestSession) UpdateMaturingPrice(_price *big.Int) (*types.Transaction, error) {
	return _StakingPoolImplementationForTest.Contract.UpdateMaturingPrice(&_StakingPoolImplementationForTest.TransactOpts, _price)
}

// UpdateMaturingPrice is a paid mutator transaction binding the contract method 0xa7a48681.
//
// Solidity: function updateMaturingPrice(uint256 _price) returns()
func (_StakingPoolImplementationForTest *StakingPoolImplementationForTestTransactorSession) UpdateMaturingPrice(_price *big.Int) (*types.Transaction, error) {
	return _StakingPoolImplementationForTest.Contract.UpdateMaturingPrice(&_StakingPoolImplementationForTest.TransactOpts, _price)
}
