...
func (_StakingPoolImplementation *StakingPoolImplementationCaller) GetDecimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _StakingPoolImplementation.contract.Call(opts, &out, "getDecimals")
...
//
// Solidity: function getDecimals() view returns(uint8)
func (_StakingPoolImplementation *StakingPoolImplementationSession) GetDecimals() (uint8, error) {
	return _StakingPoolImplementation.Contract.GetDecimals(&_StakingPoolImplementation.CallOpts)
}

// GetDecimals is a free data retrieval call binding the contract method 0xf0141d84.
//
// Solidity: function getDecimals() view returns(uint8)
func (_StakingPoolImplementation *StakingPoolImplementationCallerSession) GetDecimals() (uint8, error) {
	return _StakingPoolImplementation.Contract.GetDecimals(&_StakingPoolImplementation.CallOpts)
}
...
func (_StakingPoolImplementation *StakingPoolImplementationCaller) GetLatestPrice(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _StakingPoolImplementation.contract.Call(opts, &out, "getLatestPrice")
...
//
// Solidity: function getLatestPrice() view returns(uint256)
func (_StakingPoolImplementation *StakingPoolImplementationSession) GetLatestPrice() (*big.Int, error) {
	return _StakingPoolImplementation.Contract.GetLatestPrice(&_StakingPoolImplementation.CallOpts)
}

// GetLatestPrice is a free data retrieval call binding the contract method 0x8e15f473.
//
// Solidity: function getLatestPrice() view returns(uint256)
func (_StakingPoolImplementation *StakingPoolImplementationCallerSession) GetLatestPrice() (*big.Int, error) {
	return _StakingPoolImplementation.Contract.GetLatestPrice(&_StakingPoolImplementation.CallOpts)
}
...
func (_StakingPoolImplementation *StakingPoolImplementationTransactor) PriceConsumerInitialize(opts *bind.TransactOpts, _oracle common.Address) (*types.Transaction, error) {
	return _StakingPoolImplementation.contract.Transact(opts, "__PriceConsumer_initialize", _oracle)
}

// PriceConsumerInitialize is a paid mutator transaction binding the contract method 0x37c4f6a4.
//
// Solidity: function __PriceConsumer_initialize(address _oracle) returns()
func (_StakingPoolImplementation *StakingPoolImplementationSession) PriceConsumerInitialize(_oracle common.Address) (*types.Transaction, error) {
	return _StakingPoolImplementation.Contract.PriceConsumerInitialize(&_StakingPoolImplementation.TransactOpts, _oracle)
}

// PriceConsumerInitialize is a paid mutator transaction binding the contract method 0x37c4f6a4.
//
// Solidity: function __PriceConsumer_initialize(address _oracle) returns()
func (_StakingPoolImplementation *StakingPoolImplementationTransactorSession) PriceConsumerInitialize(_oracle common.Address) (*types.Transaction, error) {
	return _StakingPoolImplementation.Contract.PriceConsumerInitialize(&_StakingPoolImplementation.TransactOpts, _oracle)
}
...
func (_StakingPoolImplementation *StakingPoolImplementationTransactor) UpdateMaturingPrice(opts *bind.TransactOpts, _price *big.Int) (*types.Transaction, error) {
	return _StakingPoolImplementation.contract.Transact(opts, "updateMaturingPrice", _price)
}

// UpdateMaturingPrice is a paid mutator transaction binding the contract method 0xa7a48681.
//
// Solidity: function updateMaturingPrice(uint256 _price) returns()
func (_StakingPoolImplementation *StakingPoolImplementationSession) UpdateMaturingPrice(_price *big.Int) (*types.Transaction, error) {
	return _StakingPoolImplementation.Contract.UpdateMaturingPrice(&_StakingPoolImplementation.TransactOpts, _price)
}

// UpdateMaturingPrice is a paid mutator transaction binding the contract method 0xa7a48681.
//
// Solidity: function updateMaturingPrice(uint256 _price) returns()
func (_StakingPoolImplementation *StakingPoolImplementationTransactorSession) UpdateMaturingPrice(_price *big.Int) (*types.Transaction, error) {
	return _StakingPoolImplementation.Contract.UpdateMaturingPrice(&_StakingPoolImplementation.TransactOpts, _price)
}
