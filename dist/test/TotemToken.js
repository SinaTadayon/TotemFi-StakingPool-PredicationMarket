...
describe("TotemToken", function () { return __awaiter(void 0, void 0, void 0, function () {
    var signer, totemToken, deployTotemToken;
    return __generator(this, function (_a) {
            ...
            return __generator(this, function (_4) {
                switch (_4.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, totemToken.setDistributionTeamsAddresses(communityWallet.address, stakingWallet.address, liquidityWallet.address, publicWallet.address, advisorsWallet.address, seedWallet.address, privateWallet.address, teamWallet.address, strategicWallet.address)];
                    case 1:
                        _4.sent();
                    ...
                    case 20:
                        _3.apply(_1, [_4.sent()]);
                        return [4 /*yield*/, chai_1.expect(totemToken.distributeTokens(), "should distribute only once").to.be.revertedWith("")];
                    case 21:
                        _4.sent();
                        return [2 /*return*/];
                }
        ...
        it("taxation applies correctly", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_r) {
                switch (_r.label) {
                    case 0: return [4 /*yield*/, chai_1.expect(totemToken.setTaxRate(10000)).to.be.revertedWith("")];
                    case 1:
                        _r.sent();
                    ...
                    case 2:
                        ...
                        // Get some tokens to signer
                        return [4 /*yield*/, totemToken.setDistributionTeamsAddresses(signerAddress, otherWallet.address, otherWallet.address, otherWallet.address, otherWallet.address, otherWallet.address, otherWallet.address, otherWallet.address, otherWallet.address)];
                    case 3:
                        // Get some tokens to signer
                        _r.sent();
                        return [4 /*yield*/, totemToken.distributeTokens()];
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, totemToken.setTaxExemptStatus(signerAddress, false)];
                    case 9:
                        // Remove signer from tax exempt, tax will be sent to the signer(owner) by default
                        _r.sent();
                        return [4 /*yield*/, totemToken.transfer(walletA.address, 1000)];
                    ...
                    case 12:
                        ...
                        return [4 /*yield*/, totemToken.setTaxationWallet(taxationWallet.address)];
                    case 13:
                        // Set custmo taxation wallet
                        _r.sent();
                        return [4 /*yield*/, totemToken.transfer(walletA.address, 1000)];
                    ...
                    case 16:
                        ...
                        // Set custom tax rate
                        return [4 /*yield*/, totemToken.setTaxRate(500)];
                    case 17:
                        // Set custom tax rate
                        _r.sent();
                        return [4 /*yield*/, totemToken.transfer(walletA.address, 1000)];
                    ...
                    case 20:
                        ...
                        return [4 /*yield*/, totemToken.setTaxExemptStatus(signerAddress, true)];
                    case 21:
                        // Again turn on tax exempt for signer
                        _r.sent();
                        return [4 /*yield*/, totemToken.transfer(walletA.address, 1000)];
...
//# sourceMappingURL=TotemToken.js.map