...
interface IndexedClaimRewardLibInterface extends ethers.utils.Interface {
  functions: {
...
export class IndexedClaimRewardLib extends Contract {
  ...
  interface: IndexedClaimRewardLibInterface;
