...
interface CalculateRewardLibInterface extends ethers.utils.Interface {
  functions: {
...
export class CalculateRewardLib extends Contract {
  ...
  interface: CalculateRewardLibInterface;
