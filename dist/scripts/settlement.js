...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var poolAddress, fileName, csvFile, provider, account, stream, artifactFile, artifact, spiContract, spiInterface, poolType, prizeRewardRateList, sortedStakerList, stakerMap, reports, txDetails, averagePricePrediction, potentialCollabReward, collaborativeRange, totalStaked, network, blockNumber, lpsOrig, lps, i, prizeRewardRate, error_1, i, i, staker, _a, stakerAprPrize, stakerTotemPrize, stakerWrappedTokenPrize, stakerTotalStakedBalance, report, _b, claimedTotemPrize, claimedWrappedTokenPrize, claimedStakingPrize, claimedTotalStakingReturn;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    poolAddress = ethers_1.ethers.utils.getAddress("0x14f969d4f97e0e67f8681c531ea9566c81b80dd9");
                ...
                case 8:
                    lpsOrig = _c.sent();
                    lps = __assign({}, lpsOrig);
                    lps.maturingPrice = ethers_1.BigNumber.from(29964);
                    lps.usdPrizeAmount = ethers_1.BigNumber.from(500);
