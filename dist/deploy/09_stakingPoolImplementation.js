...
var func = function (hre) { return __awaiter(void 0, void 0, void 0, function () {
    var deployments, getNamedAccounts, deploy, deployer, CalculateRewardLib, ClaimRewardLib, IndexedClaimRewardLib;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, deploy("CalculateRewardLib", {
                        from: deployer,
                        log: true,
            ...
            case 2:
                ...
                return [4 /*yield*/, deploy("ClaimRewardLib", {
                        from: deployer,
                        log: true,
                        skipIfAlreadyDeployed: true,
                    })];
            case 3:
                ...
                return [4 /*yield*/, deploy("IndexedClaimRewardLib", {
                        from: deployer,
                        log: true,
                        skipIfAlreadyDeployed: true,
                    })];
            case 4:
                ...
                return [4 /*yield*/, deploy("StakingPoolImplementation", {
                        from: deployer,
                        log: true,
                        skipIfAlreadyDeployed: true,
                        libraries: {
...
exports.tags = ["StakingPoolImplementation"];
//# sourceMappingURL=09_stakingPoolImplementation.js.map