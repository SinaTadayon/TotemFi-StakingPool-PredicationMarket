...
interface StakingPoolStorageStructureInterface extends ethers.utils.Interface {
  functions: {
...
export class StakingPoolStorageStructure extends Contract {
  ...
  interface: StakingPoolStorageStructureInterface;
