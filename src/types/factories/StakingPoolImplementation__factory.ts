...
export class StakingPoolImplementation__factory extends ContractFactory {
  constructor(
    linkLibraryAddresses: StakingPoolImplementationLibraryAddresses,
    signer?: Signer
  ) {
    super(
      _abi,
      StakingPoolImplementation__factory.linkBytecode(linkLibraryAddresses),
      signer
    );
  }
