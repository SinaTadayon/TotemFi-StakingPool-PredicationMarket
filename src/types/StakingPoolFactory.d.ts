...
interface StakingPoolFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "createPoolProxy(address,address,string,string,uint256[12],uint256[8],uint256[8],bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setDefaultTaxRate",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setNewStakingPoolImplementationAdr",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "setNewSuperAdmin",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "stakingPoolImplementationAdr",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "PoolCreated(address,string,string,uint256[12],uint256[8],uint256[8],bool)": EventFragment;
    "PoolCreatorAdded(address)": EventFragment;
    "PoolCreatorRemoved(address)": EventFragment;
  };

  getEvent(
    nameOrSignatureOrTopic: "NewStakingPoolImplemnetationWasSet"
  ): EventFragment;
