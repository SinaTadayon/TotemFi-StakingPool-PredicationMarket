...
interface StakingPoolImplementationForTestInterface
  ...
  functions: {
    ...
    "batchStake(uint256[],uint256[])": FunctionFragment;
    ...
    "updateMaturingPrice(uint256,bool,uint256,address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getIndexedPrize",
  ...
  encodeFunctionData(functionFragment: "getLPS", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getPrizeTokenDecimals",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getStakingTax",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getWrappedTokenBalance",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "purchaseWrappedToken",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setActivationStatus",
    values: [boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "setOracleToZero",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, boolean, BigNumberish, string, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "BatchStake(address,uint256[],uint256[],uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "PoolUnLocked"): EventFragment;
...
export class StakingPoolImplementationForTest extends Contract {
  ...
  functions: {
    ...
    batchStake(
      _stakingAmounts: BigNumberish[],
      _predictions: BigNumberish[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    "batchStake(uint256[],uint256[])"(
      _stakingAmounts: BigNumberish[],
      _predictions: BigNumberish[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    getLPS(overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
    ...
    getPrizeTokenDecimals(
      _oracleContract: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    "getPrizeTokenDecimals(address)"(
      _oracleContract: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    updateMaturingPrice(
      _predictionPrice: BigNumberish,
      _samePredictionPrizeToken: boolean,
      _prizePrice: BigNumberish,
      _oracleContract: string,
  ...
  filters: {
    ...
    BatchStake(
      ...
      stakeAmounts: null,
      predictions: null,
      indexOfFirstStake: null,
      indexOfLastStake: null
    ): TypedEventFilter<
      [string, BigNumber[], BigNumber[], BigNumber, BigNumber],
      {
        user: string;
        stakeAmounts: BigNumber[];
        predictions: BigNumber[];
        indexOfFirstStake: BigNumber;
        indexOfLastStake: BigNumber;
      }
    >;
    ...
    WithdrawStakingReturn(
      ...
      [string, BigNumber],
      { user: string; stakingReturn: BigNumber }
    >;
    ...
    WithdrawTotemPrize(
      ...
      [string, BigNumber],
      { user: string; totemPrize: BigNumber }
    >;
    ...
    WithdrawWrappedTokenPrize(
      ...
      [string, BigNumber],
      { user: string; wrappedTokenPrize: BigNumber }
    >;
  };
  ...
  estimateGas: {
    ...
    getLPS(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getLPS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
